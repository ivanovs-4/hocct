...
module HOCCT.ModelingAlgorithms.BRepAlgoAPI_BooleanOperation.Implementation
       where
import Data.Monoid
import Data.Word
import Data.Int
...
import HOCCT.ModelingAlgorithms.BRepAlgoAPI_BooleanOperation.FFI
...
instance () =>
         IBRepAlgoAPI_BooleanOperation (BRepAlgoAPI_BooleanOperation)
         where
        build = xform0 c_brepalgoapi_booleanoperation_build

instance () =>
         IBRepAlgoAPI_BuilderAlgo (BRepAlgoAPI_BooleanOperation)
         where

instance () => IBRepAlgoAPI_Algo (BRepAlgoAPI_BooleanOperation)
         where

instance () =>
         IBRepBuilderAPI_MakeShape (BRepAlgoAPI_BooleanOperation)
         where
        shape = xform0 c_brepalgoapi_booleanoperation_shape

instance () =>
         IBRepBuilderAPI_Command (BRepAlgoAPI_BooleanOperation)
         where
